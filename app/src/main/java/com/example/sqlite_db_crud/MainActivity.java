    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                String selectedProductName = adapterView.getItemAtPosition(i).toString();
                Intent intent = new Intent(MainActivity.this, Activity_Edit_Product.class);
    ...
    private void deleteProduct(String productName){
        ...
        for (int i=0; i < products.size(); i++){
            ...
            if (product1.getName().equals(productName)){
                ...
                Toast.makeText(MainActivity.this, "Deleted "+product1.getName(), Toast.LENGTH_SHORT).show();
                break;
            }
        }
    }
